...
?>
	...
	<main id="main" class="site-main">
		...
		3.828 11.828 12H6.172zm12 0L20 10.172 21.828 12h-3.656z' fill='%23ffffff' fill-opacity='0.05'
		fill-rule='evenodd'/%3E%3C/svg%3E");">
		<div class="container">
			<h2 class="text-center mb-4" style="color: #FFF;">Links importantes</h2>

			<div class="row">
				<div class="overflow-wrapper">
					<div id="feature_card-2" class="col-sm-12 col-md-6 col-lg-4 mb-4 widget_feature_card">
						<div class="menu-col">
							<div class="feature-card text-center card-1">
								<a href="http://www.cidadania.gov.br/leideincentivoacultura" target="_blank">
									<div class="align">
										<div class="icon icon-lei-incentivo"></div>
										<h3 class="card-title">Lei de Incentivo à Cultura</h3>
									</div>
								</a>
							</div>
						</div>
					</div>
					<div id="feature_card-3" class="col-sm-12 col-md-6 col-lg-4 mb-4 widget_feature_card">
						<div class="menu-col">
							<div class="feature-card text-center card-1">
								<a href="http://salic.cultura.gov.br/autenticacao/index/index" target="_blank">
									<div class="align">
										<div class="icon icon-search_b"></div>
										<h3 class="card-title">Salic</h3>
									</div>
								</a>
							</div>
						</div>
					</div>
					<div id="feature_card-4" class="col-sm-12 col-md-6 col-lg-4 mb-4 widget_feature_card">
						<div class="menu-col">
							<div class="feature-card text-center card-1">
								<a href="http://versalic.cultura.gov.br/#/home" target="_blank">
									<div class="align">
										<div class="icon icon-eye"></div>
										<h3 class="card-title">Versalic</h3>
									</div>
								</a>
							</div>
						</div>
